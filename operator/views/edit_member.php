<?php
    $data_member = mysqli_fetch_assoc(mysqli_query($koneksi, "SELECT * FROM member WHERE id_member = '$_GET[id_member]'"));
?>
        ...
        <div class="col py-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>
                        Tattooed Codeply Echo Park Godard kogi, next level irony ennui twee squid fap selvage. Meggings flannel Brooklyn literally small batch, mumblecore PBR try-hard kale chips. Brooklyn vinyl lumbersexual bicycle rights,
                        viral fap cronut leggings squid chillwave pickled gentrify mustache. 3 wolf moon hashtag church-key Odd Future. Austin messenger bag normcore, Helvetica Williamsburg sartorial tote bag distillery Portland before they
                        sold out gastropub taxidermy Vice.
                    </p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" id="alamat" rows="3" class="form-control" autocomplete="street-address" placeholder="Masukan Alamat Member"><?= $data_member['alamat'] ?></textarea></div>
                    <div class="form-group">
